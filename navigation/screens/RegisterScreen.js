    ...
    return (
        ...
        <TouchableOpacity onPress={pickImage}>
            ...
            <>
                ...
                <TextInput placeholder={i18n.t('email')} value={email} selectionColor='#0782F9' activeUnderlineColor='#0782F9' onChangeText={text => setRegisteredEmail(text)} keyboardType='email-address' style={[globalStyles.input, {backgroundColor: 'white'}]}/>
            ...
            <>
                ...
                <TextInput placeholder={i18n.t('email')} theme={{colors: {text: 'white'}}} placeholderTextColor='#fff' value={email} selectionColor='#0782F9' activeUnderlineColor='#0782F9' onChangeText={text => setRegisteredEmail(text)} keyboardType='email-address' style={[globalStyles.input, {backgroundColor: 'black'}]}/>
